...
export const PosterPrompt = `Toei Animation One Piece anime style. Bust portrait. Anime styled but preserve the facial structure, face shape, and features of the reference photo. Natural eye size, realistic eye proportions, no exaggerated large anime eyes. Unique creative outfit inspired by One Piece character designs. Vibrant saturated colors, clean flat cel-shading, thick black outlines. High energy dynamic composition. Character is the clear focal point, background soft blurred and desaturated.
Negative prompt: generic pirate coat, standard red pirate jacket, tricorn hat, large anime eyes, exaggerated eyes, modern clothes, casual clothes, plain outfit, muted colors, 3D, blurry, greyscale, sketch, busy background, overpowering background`;
